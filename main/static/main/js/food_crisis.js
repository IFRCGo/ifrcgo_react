...
var load_dashboard = function() {
	...
	//Country metadata
	d3.dsv(';')("../static/main/data/food_crisis/country_metadata.csv", function(metadata_country){
		...
		//Geodata
		d3.json("../static/main/data/food_crisis/geo_level" + (admlevel - 2) + ".json", function (geo_data) {
...
var generateCharts = function (d){
	...
	var createHTML = function(keyvalue) {
		...
		for (var i=0;i<tables.length;i++) {
			...
			if (!meta_icon[record.name]) {var icon = '../static/main/images/food_crisis/undefined.png';}
			else {var icon = '../static/main/images/food_crisis/'+meta_icon[record.name];}
			...
			if (record.group === 'general') {
				...
				var img = document.createElement('img');
				img.setAttribute('src','../static/main/images/food_crisis/icon-popup.svg');
				...
				img2.setAttribute('src','modules/dashboards/main/images/food_crisis/icon-scale.svg');
				...
				*/
				...
				img3.setAttribute('src','../static/main/images/food_crisis/icon-popup.svg');
			...
			/*
				...
				var img2 = document.createElement('img');
				img2.setAttribute('class','scale-icon');
				img2.setAttribute('src','main/images/food_crisis/icon-scale.svg');
				div2a.appendChild(img2);
				var div3 = document.createElement('div');
				div3.setAttribute('class','col-sm-2 col-md-2 no-padding');
				div.appendChild(div3);
				...
				//$compile(button)($scope);
				var img3 = document.createElement('img');
				img3.setAttribute('src','main/images/food_crisis/icon-popup.svg');
				img3.setAttribute('style','height:17px');
				button.appendChild(img3);
			}
			*/
	...
	info = function(id) {	// don't define with 'var' so it's a global function
		...
		if (!meta_icon[metric]) {metric_icon = 'main/images/food_crisis/undefined.png';}
		else {metric_icon = 'main/images/food_crisis/' + meta_icon[metric];}
